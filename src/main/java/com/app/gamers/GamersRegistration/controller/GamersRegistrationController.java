...
public class GamersRegistrationController {
	...
	@PostMapping("/creditsGamer")
	public String creditsGamer(@RequestBody Credit credit) {
		return servicel.creditsGamer(credit);
	}

	
	 @GetMapping("/getGamerMaxCredits/{name}") 
	 public Integer getGamerMaxCredits(@PathVariable("name") String gameName) { 
		 return servicel.findGamerMaxCredits(gameName); 	 
	 }
